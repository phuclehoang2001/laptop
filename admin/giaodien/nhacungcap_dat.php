        ...
        <div class="product-items">
            <div class="buttons">
                <form name="nhacungcap-formdat" method="POST" action="./admin.php?act=ncccartlist&idncc=<?= $_GET['id'] ?>" enctype="multipart/form-data">
                    <input name="btnnccdat" type="submit" title="Lưu nhà cung cấp" value="Giỏ hàng" />
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['so_luong'] ?></td>
                                <td>
                                    <a href="./admin.php?act=ncccart&id=<?= $row['id'] ?>&idncc=<?= $_GET['id'] ?>"><i class="fas fa-shopping-cart"></i></a>
