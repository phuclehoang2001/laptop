...
?>
    <div class="main-content" style="width: fit-content">
        <h1 style="text-align: center;">Phiếu nhập</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="./admin.php?act=xoapn&id=<?= $row['idpn'] ?>" style="text-decoration: none;"onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash-alt"></i></a></td>
