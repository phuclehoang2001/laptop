				...
				<?php if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
					if (isset($_SESSION['ten_dangnhap']) && !empty($_SESSION['ten_dangnhap'])) {
						...
						if ($khachhang['ten_kh'] == "" || $khachhang['dia_chi'] == "")
							echo '<a href="index.php?act=my_account" style="width:100%" class="primary-btn order-submit" >Vui Lòng điền đủ tên và địa chỉ trong phần thông tin cá nhân để Tiến Hành THanh Toán</a>';
						else
