			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="./img/dellg5155500featured-500x500.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Dell<br>Collection</h3>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="./img/msi-gf65-10ue-i7-228vn-5-1_1020x570-800-resize.jpg" alt="">
							</div>
							<div class="shop-body">
